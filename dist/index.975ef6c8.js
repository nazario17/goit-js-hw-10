...
var _createMarkUp = require("./js/createMarkUp");
const DEBOUNCE_DELAY = 300;
const inputEl = document.querySelector("#search-box");
const list = document.querySelector(".country-list");
inputEl.addEventListener("input", (0, _lodashDebounceDefault.default)(onSearch, DEBOUNCE_DELAY));
function onSearch(event) {
    ...
    (0, _fetchCountries.fetchCountries)(value.toLowerCase()).then((data)=>{
        if (data.length > 10) {
            (0, _notiflixNotifyAio.Notify).failure("Too many matches found. Please enter a more specific name.");
            list.innerHTML = "";
            return;
        } else if (data.length >= 2 && data.length <= 10) list.innerHTML = (0, _createMarkUp.createMarkUpForAllCountries)(data);
        else if (data.length === 1) list.innerHTML = (0, _createMarkUp.createMarkUpForOneCountry)(data);
    }).catch((error)=>{
        console.dir(error);
...
},{"./css/styles.css":"1CY4s","lodash.debounce":"3JP5n","notiflix/build/notiflix-notify-aio":"eXQLZ","./js/fetchCountries":"dKuy9","./js/createMarkUp":"j9TYg","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1CY4s":[function() {},{}],"3JP5n":[function(require,module,exports) {
var global = arguments[3];
/**
...
function fetchCountries(name) {
    ...
    return fetch(`${BASE_URL}/name/${name}?fields=name,capital,languages,population,flags`).then((resp)=>{
...
},{}],"j9TYg":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "createMarkUpForOneCountry", ()=>createMarkUpForOneCountry);
parcelHelpers.export(exports, "createMarkUpForAllCountries", ()=>createMarkUpForAllCountries);
...
function createMarkUpForAllCountries(arr) {
